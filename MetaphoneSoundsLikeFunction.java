...
@FunctionTemplate(
        name = "metaphone_sounds_like",
        scope = FunctionTemplate.FunctionScope.SIMPLE,
        nulls = FunctionTemplate.NullHandling.NULL_IF_NULL
)
public class MetaphoneSoundsLikeFunction implements DrillSimpleFunc{
    ...
    public void eval() {
        ...
        if( org.apache.drill.contrib.function.PhoneticFunctions.metaphone( string1 ).equals(  org.apache.drill.contrib.function.PhoneticFunctions.metaphone( string2 ) ) )
        {
            result = 1;
        }
