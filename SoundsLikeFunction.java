...
public class SoundsLikeFunction implements DrillSimpleFunc {
    ...
    public void eval() {
		...
		if( org.apache.drill.contrib.function.PhoneticFunctions.soundex( string1 ).equals(  org.apache.drill.contrib.function.PhoneticFunctions.soundex( string2 ) ) )
		{
			result = 1;
		}
